...
- [Next mechanistic frontier] Decompose the remaining seat dependence into opportunity/visitation effects versus conditional response effects before promoting any seat-general Control observable.
