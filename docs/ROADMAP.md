...
- [Frozen prospective test; ready to run] `CONTEXT_MATCHED_TRANSITION_FALSIFICATION_PLAN.md` fixes fresh seeds 1101-1105, the facing-bet bet-call and round-1-open bet-check primary endpoints, a 4-of-5 sign-replication rule, and a secondary seat-gap attenuation diagnostic. Run once without retuning and record the result.
