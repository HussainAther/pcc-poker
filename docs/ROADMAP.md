...
- [Next prospective test] Freeze a matched-context interaction analysis on fresh synthetic seeds to test whether the Control-heavy adjacency signal replicates specifically in facing-bet bet-call and open-round bet-check contexts, and whether the seat asymmetry attenuates after conditioning on those contexts.
